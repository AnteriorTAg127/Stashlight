package dev.strangequark.containerlookup;
...
import dev.strangequark.containerlookup.render.HighlightRenderer;
import dev.strangequark.containerlookup.repository.ContainerRepository;
import dev.strangequark.containerlookup.screen.SearchScreen;
import dev.strangequark.containerlookup.serializer.Serializer;
import dev.strangequark.containerlookup.util.Util;

import java.util.Set;

public class ContainerLookup implements ClientModInitializer {
    public static final String MOD_ID = "containerlookup";
    public static final Logger LOGGER = LoggerFactory.getLogger(MOD_ID);

    private Serializer serializer;
    private ContainerRepository repository;
    private static KeyBinding searchKey;
    public static final KeyBinding.Category CONTAINER_LOOKUP = KeyBinding.Category.create(Identifier.of(MOD_ID, "containerlookup"));
