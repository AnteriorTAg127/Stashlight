package strangequark.containerlookup.gui;
...
import strangequark.containerlookup.render.HighlightManager;

import java.util.ArrayList;
import java.util.List;

import static strangequark.containerlookup.gui.UIStyle.SLOT_SIZE;
